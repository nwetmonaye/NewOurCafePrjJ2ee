...
<form action="deletmenutable.jsp">

<table>
<tr><td id="lab">
<label>Enter Food No:</label><input type="text" name="fid"/></td></tr>
<!-- <tr><td id="lab">Enter Name that when ur login:</td>
<td><input type="text" name="name"/></td></tr> -->
<tr><td colspan="2">
<br><input type="submit" value="Delete" class="buttonlogin"/>
</td>
